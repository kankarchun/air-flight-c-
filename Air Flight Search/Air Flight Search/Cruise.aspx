<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cruise.aspx.cs" Inherits="Air_Flight_Search.Cruise" %>
...
<body class="auto-style5">
    ...
    <div class="auto-style1">
        ...
        <div class="auto-style1">
            ...
            <br />
            <strong><span class="auto-style2">Cruise Record</span></strong></div>
                <strong>Organiser Name:<asp:TextBox ID="TextBox1" runat="server" CssClass="auto-style4" Width="153px"></asp:TextBox>
        <br />
                Price:<asp:TextBox ID="TextBox10" type="number" runat="server" Width="46px"></asp:TextBox>
&nbsp;To
                <asp:TextBox ID="TextBox11" type="number" runat="server" Width="46px"></asp:TextBox>
        <br />
